        ...
        <?php if ($teamResult->num_rows > 0): ?>
            ...
            <div class="glass-card p-6 mb-8">
                <div class="flex justify-between items-center mb-6 header-actions">
                    <h2 class="text-2xl font-bold text-gray-800">Your Team:
                        <?php echo htmlspecialchars($teamData['team_name']); ?>
                    </h2>
                    <button class="text-orange-500 hover:text-orange-700 transition-colors duration-300 flex items-center"
                        ...
                        <div class="input-group">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="team_name" name="team_name"
                                    value="<?php echo htmlspecialchars($teamData['team_name']); ?>" required
                                    class="form-input input-with-icon">
                            </div>
                        </div>
                        <div class="flex gap-3 responsive-flex">
                            <button type="submit" name="update_team"
                                class="btn-gradient text-white px-4 py-2 rounded-md flex items-center">
                                <i class="fas fa-save mr-2"></i> Save Changes
                            </button>
                            <button type="button" onclick="toggleEditTeam()"
                    ...
                    <div id="add-member-form" class="mb-6 hidden">
                        <form method="POST">
                            ...
                            <div class="flex gap-2 responsive-button-group">
                                ...
                                <button type="button" onclick="toggleAddMember()"
                                    class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 transition-colors duration-300 flex items-center">
                                    <i class="fas fa-times mr-2"></i> Cancel
                                </button>
                            </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <form method="POST" class="inline">
                                                ...
                                                <button type="submit" name="remove_member"
                                                    class="text-red-600 hover:text-red-900 transition-colors duration-300" <?php if ($member_count <= 1 && $member['user_id'] == $user_id): ?>disabled<?php endif; ?>>
                ...
                <div class="mt-10 border-t pt-6 flex justify-between team-actions">
                    <a href="../categories/event_details.php?event_id=<?php echo $event_id; ?>"
                        class="inline-flex items-center text-gray-700 hover:text-gray-900 transition-colors duration-300">
                    ...
                    <form method="POST"
                        ...
                        <button type="submit" name="delete_team"
                            class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md inline-flex items-center transition-colors duration-300">
            ...
            <div class="glass-card p-6">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div class="flex justify-between responsive-flex">
                        <a href="../categories/event_details.php?event_id=<?php echo $event_id; ?>"
                            class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 inline-flex items-center transition-colors duration-300">
                            <i class="fas fa-arrow-left mr-2"></i> Back to Events
                        </a>
                        <button type="submit" name="create_team"
                            class="btn-gradient text-white px-6 py-2 rounded-md flex items-center">
