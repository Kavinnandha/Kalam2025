...
<body class="bg-yellow-50" x-data="{ 
            ...
            <div @click="goToEventDetails(item.event_id)" 
                ...
                <div class="sm:hidden p-4">
                    ...
                    <div class="flex items-start space-x-3 mb-3">
                        <!-- Image column -->
                        <div class="w-20 h-20 bg-orange-100 rounded-lg flex-shrink-0 flex items-center justify-center">
                            <template x-if="item.image_path">
                                <img :src="item.image_path" :alt="item.event_name" 
                        ...
                        <div class="flex-1 min-w-0 flex flex-col">
                            ...
                            <h3 class="text-base font-semibold text-yellow-800 line-clamp-2 leading-tight" x-text="item.event_name"></h3>
                    ...
                    <div class="pl-2">
                        <p class="text-xs text-yellow-600 mb-2 line-clamp-2" x-text="item.event_detail"></p>
                        ...
                        <div class="grid grid-cols-2 gap-x-2 gap-y-1 text-xs">
                            ...
                            <div class="text-orange-700">
                                <span x-text="'Time: ' + item.start_time + ' - ' + item.end_time"></span>
                            </div>
    ...
    <!-- Order Summary Modal -->
    <div class="modal-backdrop" x-show="showOrderModal" x-cloak
         x-transition:enter="transition ease-out duration-300"
        ...
        <div class="modal-content" 
            ...
            <div class="p-6">
                ...
                <div class="mb-6 bg-yellow-50 p-4 rounded-lg">
                    ...
                    <p class="text-sm text-yellow-700"><span class="font-medium">Name:</span> <span x-text="orderSummary.userData.name"></span></p>
                    <p class="text-sm text-yellow-700 mt-1"><span class="font-medium">Email:</span> <span x-text="orderSummary.userData.email"></span></p>
                    <p class="text-sm text-yellow-700 mt-1"><span class="font-medium">Phone:</span> <span x-text="orderSummary.userData.phone"></span></p>
                </div>
                        ...
                        <div class="divide-y divide-yellow-100">
                            <template x-for="(item, index) in orderSummary.items" :key="index">
                                <div class="p-4 flex justify-between items-center">
                                    ...
                                    <div class="text-right">
                                        <p class="font-semibold text-orange-700" x-text="'₹' + parseFloat(item.registration_fee).toFixed(2)"></p>
                                    </div>
                                </div>
                            </template>
                        </div>
