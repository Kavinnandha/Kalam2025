...
<body class="bg-gradient-to-br from-orange-50 to-yellow-50 pb-16 md:pb-0">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-12">
                <div class="relative inline-block">
                    ...
                    <h1
                        class="text-4xl font-bold bg-gradient-to-r from-orange-600 to-yellow-500 text-transparent bg-clip-text">
                        <?php echo htmlspecialchars($department['department_name']); ?> Events
                    </h1>
                    <div
                        class="absolute -bottom-2 left-0 h-1 w-24 bg-gradient-to-r from-orange-500 to-yellow-400 rounded-full">
                    </div>
                </div>
            </div>
                ...
                <?php while ($event = $events->fetch_assoc()): ?>
                    <div class="h-full flex flex-col">
                        ...
                        <a href="event_details.php?event_id=<?php echo urlencode($event['event_id']); ?>"
                            ...
                            <div
                                class="bg-white h-full rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                                ...
                                <div class="p-6 flex flex-col h-[calc(100%-12rem)]">
                                    <!-- Category Badge -->
                                    <div
                                        class="inline-block px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-orange-100 to-yellow-100 text-orange-700 mb-4 w-fit">
                        ...
                        <?php if ($event['category'] == 'General'): ?>
                            <button
                                onclick="window.location.href='event_details.php?event_id=<?php echo urlencode($event['event_id']); ?>'"
