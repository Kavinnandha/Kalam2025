    ...
    <div class="relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 pt-24 pb-12 relative mobile-hero">
            <div class="text-center slide-in-bottom">
                <h1 class="mt-4 text-4xl md:text-5xl mobile-title font-extrabold mb-3 text-white drop-shadow-lg">Terms & Conditions</h1>
        ...
        <div class="max-w-4xl mx-auto bg-white shadow-xl rounded-xl p-8 slide-in-bottom delay-100 mobile-p">
                ...
                <div id="toc-container" class="overflow-x-auto">
                    <div class="grid grid-cols-1 gap-2 min-w-full">
                        <a href="#section1" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            ...
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Event Registration Policy</span>
                        </a>
                        ...
                        <a href="#section3" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            ...
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Event Fee and Payment</span>
                        </a>
                        ...
                        <a href="#section6" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            ...
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Liability Disclaimer</span>
                        </a>
                        <a href="#section7" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            ...
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Event Postponement or Cancellation</span>
                        </a>
                        <a href="#section8" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            ...
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Photography and Media Consent</span>
                        </a>
                        <a href="#section9" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                        ...
                        <a href="#section10" class="group flex items-center p-2 hover:bg-white rounded-md transition-all duration-300">
                            <span class="text-orange-500 font-bold mr-2 group-hover:text-red-500">10.</span>
                            <span class="text-gray-700 group-hover:text-orange-600 mobile-text">Agreement to Terms</span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div id="section1" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <p class="ml-14 text-gray-700 leading-relaxed mobile-ml mobile-text">
                    By registering for any event conducted by <strong class="text-orange-600">Sri Shakthi Institute of Engineering and Technology</strong> 
                    (hereinafter referred to as "the organizer"), you agree to comply with all the terms and conditions mentioned herein.
                </p>
            </div>
            ...
            <div id="section2" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <p class="ml-14 text-gray-700 leading-relaxed mobile-ml mobile-text">
                    Participation in the event is open to students from any educational institution, provided they meet the eligibility criteria defined for each event.
                    Participants must provide valid identification proof (College ID, Government ID, etc.) during the event if requested.
                </p>
            </div>
            ...
            <div id="section3" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Participants are required to pay a one-time <span class="font-semibold">general event registration fee of ₹150</span> for attending any general event.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Any technical or premium event may have an additional fee specified during registration.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Payments are accepted through the authorized payment gateway integrated on our website.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Ensure that you review all event details and fees before completing your payment.
                    </p>
                </div>
            </div>

            <div id="section4" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-red-500 mobile-section">
                <div class="flex items-start sm:items-center mb-3">
                    <div class="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-red-600 text-white font-bold mr-3 mobile-icon min-w-10">4</div>
                    <h2 class="text-2xl font-bold text-gray-800 mobile-subtitle">No Refund Policy</h2>
                </div>
                <div class="ml-14 text-red-600 leading-relaxed space-y-2 p-4 bg-red-50 rounded-lg border border-red-100 mobile-ml">
                    <p class="font-medium mobile-text">
                        <i class="fas fa-exclamation-circle mr-2"></i> <strong>All payments made towards event registrations are non-refundable and non-transferable under any circumstances.</strong>
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs mr-2"></i> Once the payment is successful, no refunds or cancellations will be entertained.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs mr-2"></i> Failure to attend the event will not qualify for any refunds or future credits.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs mr-2"></i> In case the event is postponed or rescheduled, the participant will be notified, and the registration will remain valid.
                    </p>
                </div>
            </div>
            ...
            <div id="section5" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> All participants are expected to maintain decorum and adhere to the guidelines set by the organizers.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Any form of misbehavior, misconduct, or violation of rules may lead to <span class="font-semibold text-red-600">immediate disqualification</span> without a refund.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Damaging event property, misconduct, or failure to follow instructions from event organizers may lead to legal action.
                    </p>
                </div>
            </div>
            ...
            <div id="section6" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> The organizer shall not be responsible for any loss, damage, injury, or accidents caused to the participants during the event.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> The participants are responsible for their own belongings and are encouraged to take care of their valuables.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Any injuries, accidents, or health issues during the event are the participant's sole responsibility, and the organizers will not provide any insurance coverage.
                    </p>
                </div>
            </div>
            ...
            <div id="section7" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> In case of unforeseen circumstances such as natural calamities, emergencies, or government restrictions, the event may be postponed or canceled.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> In the event of cancellation, the registration fees will <span class="font-semibold text-red-600">not</span> be refunded but may be carried forward to future events at the discretion of the organizers.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> The organizer reserves the right to change the venue, date, or time of the event without prior notice.
                    </p>
                </div>
            </div>
            ...
            <div id="section8" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                ...
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> By participating in the event, you grant the organizer the right to use your photographs, videos, or any media captured during the event for promotional and marketing purposes.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> If you do not wish to have your media published, you must notify the organizer in advance via email.
                    </p>
                </div>
            </div>

            <div id="section9" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                <div class="flex items-start sm:items-center mb-3">
                    <div class="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-orange-400 to-red-500 text-white font-bold mr-3 mobile-icon min-w-10">9</div>
                    <h2 class="text-2xl font-bold text-gray-800 mobile-subtitle">Data Privacy</h2>
                </div>
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> The information provided by participants during registration (such as Name, Email, Phone Number, College Name) will be used solely for event communication purposes.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Your personal information will not be shared with third-party entities without your consent.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> By registering, you consent to receive updates and communications regarding future events organized by the institution.
                    </p>
                </div>
            </div>

            <div id="section10" class="mb-8 hover:shadow-md transition-all duration-300 p-5 rounded-lg border-l-4 border-orange-400 hover:border-red-500 mobile-section">
                <div class="flex items-start sm:items-center mb-3">
                    <div class="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-orange-400 to-red-500 text-white font-bold mr-3 mobile-icon min-w-10">10</div>
                    <h2 class="text-2xl font-bold text-gray-800 mobile-subtitle">Agreement to Terms</h2>
                </div>
                <div class="ml-14 text-gray-700 leading-relaxed space-y-2 mobile-ml">
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> By registering and participating in the event, you acknowledge that you have read, understood, and agree to all the terms and conditions mentioned above.
                    </p>
                    <p class="mobile-text">
                        <i class="fas fa-circle text-xs text-orange-500 mr-2"></i> Violation of any of these terms may result in <span class="font-semibold text-red-600">disqualification</span> from the event without any refund or future consideration.
                    </p>
                </div>
            </div>
