...
<div class="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-lg z-100 border-t border-gray-200">
    <div class="flex justify-around items-center h-16">
        ...
        <!-- Account/Register -->
        <?php if (!isset($_SESSION['user_id'])): ?>
            <a href="/kalam/user/registration.php" class="flex flex-col items-center justify-center w-full py-2 text-gray-700 hover:text-orange-400 transition-all duration-300">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
